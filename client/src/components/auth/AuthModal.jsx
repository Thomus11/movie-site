      ...
      <div className="bg-[#0B0C10] rounded-xl shadow-lg w-full max-w-md p-8 animate-fade-in relative text-white">
        ...
        <form className="space-y-4" onSubmit={formik.handleSubmit}>
          ...
          <div>
            <select
              name="role"
              className="w-full border border-gray-600 bg-transparent text-white px-4 py-2 rounded-lg focus:outline-none focus:ring-2 focus:ring-white"
